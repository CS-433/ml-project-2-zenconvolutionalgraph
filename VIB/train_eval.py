...
def my_train_and_evaluate(
    ...
    Parameters:
        train_graphs_list: List of training graphs.
        test_graphs_list: List of testing graphs.
        model: The model to be trained.
        epochs: Number of epochs to train.
        batch_size: Batch size for training.
        test_batch_size: Batch size for validation/testing.
        lr: Learning rate.
        lr_decay_factor: Factor by which to decay the learning rate.
        lr_decay_step_size: Epoch step size for learning rate decay.
        weight_decay: Weight decay (L2 regularization).
        logger: Optional logger function to log training progress.
    ...
    test_loader = DataLoader(test_graphs_list, test_batch_size, shuffle=False, num_workers=4, pin_memory=True)
